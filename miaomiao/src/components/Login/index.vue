<template>
    <div class="login_body">
        ...
        <div>
            <input type="text" class="login_text" v-model="verifyImg" placeHolder="请输入验证码">  <img @touchstart="handleToVerifyImg" src="/ajax2/users/verifyImg">
        </div>
        <div class="login_btn">
...
export default {
    ...
    methods : {
        handleToLogin(){
            this.$axios.post('/ajax2/users/login',{
